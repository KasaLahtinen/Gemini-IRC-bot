...
import requests
import validators
from bot import IRCBot, log_resource_usage
from commands import hello_command, join_command
...
class TestIRCBot(unittest.TestCase):
    ...
    def test_process_data(self):
        ...
        with (
            patch.object(IRCBot, "send_message") as mock_send_message,
    ...
    def test_run(self):
        ...
        with patch.object(socket.socket, "recv") as mock_recv, patch.object(socket.socket, "send") as mock_send:
